...
<div class="page-content">
      ...
      <div class="row">
            <div class="col-xs-12">
                  ...
                  echo form_open('publicidad/guardar_foto', $atributosForm); ?>
                  
                        <div class="form-group">
                              <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Ubicacion de la Publicidad </label>

                              <div class="col-sm-9">

                                <select class="col-xs-10 col-sm-5" id="cMultTitulo" type="text" name="cMultTitulo">
                                  <option value="principal">Publicidad Principal (Slider)</option>
                                  <option value="derecha">Publicidad Derecha</option>
                                  <option value="abajo">Publicidad Abajo</option>
                                </select>                              
                              </div>
                        </div>
                        ...
                        <div class="form-group">
                              <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Prioridad de la Publicidad </label>

                              <div class="col-sm-9">
                                    <select class="col-xs-10 col-sm-5" id="cMultDescripcion" type="text" name="cMultDescripcion">
                        ...
                        <div class="clearfix form-actions">
                              <div class="col-md-offset-3 col-md-9">
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    <a href="<?=URL_MAIN?>publicidad" class="btn">
