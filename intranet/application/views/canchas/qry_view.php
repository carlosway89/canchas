                        ...
                        <tr>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a target="_blank" href="<?php echo URL_PORTAL ?>canchas/informacion/<?php echo $url_nombre_cancha."_".$list_canchas->nCanID ?>" data-rel="tooltip" data-original-title="Default" class="blue ver-cancha">
