    ...
    function qryubigeos($accion, $idDepa, $idProv, $tipo_accion, $mantenedor, $nom_mantenedor) {
        ...
        if ($query->num_rows() > 0) {
            ...
            if ($nom_mantenedor == "provincias") {
                ...
                echo form_dropdown('cbo_'.$tipo_accion.'_'.$mantenedor.'_'.$nom_mantenedor, $cbo_ubigeo,'', 'id="cbo_'.$tipo_accion.'_'.$mantenedor.'_'.$nom_mantenedor . '" class="col-sm-3"');
            ...
            echo form_dropdown('cbo_' . $mantenedor . '_' . $tipo_accion . '_' . $nom_mantenedor, $cbo_ubigeo, '', 'id="cbo_'.$tipo_accion.'_'.$mantenedor.'_'.$nom_mantenedor . '"  class="col-sm-3"');
        }
    }
