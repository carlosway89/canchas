...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-07-2014 a las 04:00:53
...
vema.cDetCanValor as email,
vweb.cDetCanValor as sitio_web,
udepa.nUbiDepartamento as departamento,
uprov.nUbiProvincia as provincia,
udis.nUbiDistrito as distrito,
...
BEGIN
	SELECT u.cUsuNick, concat(cPerApellidos,' ',cPerNombres) as cPerNomApe,u.nPerID,u.nUsuID 
	FROM usuarios u 
	INNER JOIN persona p ON p.nPerID = u.nPerID 
	WHERE 
	cUsuNick = _usuario AND 
	cUsuClave = _clave AND 
	cPerEstado = 'H' AND 
	cUsuEstado = 'H';
END$$
...
UPDATE canchas SET cCanEstado = _estado WHERE nCanID = _codigo;

ELSEIF _accion = 'UPD-CANCHAS' THEN
UPDATE canchas SET cCanNombre = '' WHERE nCanID = _codigo;
...
(1, 'VillaSports Precursores', 'Descripcion completa', '-8.1090524', '-79.0215336', '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H', 'img-demo3.jpg'),
(2, 'Planeta Gol Club', 'Además de prestar un servicio a sus deportistas, Planeta Gol Club tiene como objetivo suplir las necesidades y comodidades de los acompañantes, porque como dice su propietario Jason Morales, el fútbol 5 es un deporte para disfrutar en familia.', '-8.107650351299949', '-79.03573857894287', '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H', 'img-demo4.jpg'),
(3, 'Canchas Soccer Math', 'Tiene dos sedes, una en el centro (Calle 19 # 4-71) y otra en Corferias (Avenida Las Américas # 39 - 36). Ambas cuentan con lo necesario para brindar un servicio grato a sus deportistas. ', '-8.113853317605939', '-79.03659688582763', '13', '2', '1361', '2014-07-03 00:00:00', 0, 'H', 'img-demo5.jpg'),
(4, 'Campín 5', 'Con el propósito de cumplirle a los deportistas y a sus acompañantes, este lugar cuenta con 5 canchas, cada una de ellas con un camerino propio, baño, duchas, puntos de hidratación, graderías para las barras de los equipos y parqueadero.', '-8.10310428099431', '-79.04539453139648', '15', '1', '1480', '2014-07-03 00:00:00', 0, 'H', 'img-demo6.jpg'),
(5, 'SPORT ARENA', 'En el mítico barrio de Boedo se ubica uno de los mejores predios multideportivos para jugar al fútbol, el Campus Sport Arena. Este espacio tiene 8 canchas, seis de fútbol 5 y dos de fútbol 8. ', '-8.099237956490336', '-79.04045926680908', '13', '1', '1356', '2014-07-03 00:00:00', 0, 'H', 'img-demo7.jpg'),
(6, 'VIEYTES', 'Arrimándonos a la zona sur de la ciudad pero sin alejarnos demasiado del centro, nos encontramos con el clásico Complejo Vieytes. Ahí se desarrollan desde hace muchos años torneos de alta calidad futbolística y muy bien organizados, tanto para particulares como para empresas', '-8.09843069723768', '-79.03393613448486', '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H', 'img-demo.jpg'),
(7, 'MARANGONI ROSALES', 'Volviendo hacia la zona norte, detrás del club Obras Sanitarias, se destaca el predio de canchas Muni Fútbol en Núñez. Las canchas están en excelente estado y hay alternativas desde 6 hasta 8 jugadores, techadas y sin techar.', '-8.096561248544479', '-79.04290544143066', '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H', 'img-demo8.jpg'),
(8, 'MARANGONI', 'En la zona norte de la ciudad y cerca del Alto Palermo, aparece un espacio en el que todo futbolista amateur alguna vez jugó un partidito: el Complejo Claudio Marangoni.', '-8.091080314869291', '-79.04389249434814', '13', '1', '1350', '2014-07-03 00:00:00', 0, 'I', 'img-demo9.jpg'),
(9, 'cancha prueba', 'descripcion prueba', '123456', '-123456', '13', '1', '1350', '2014-07-25 17:04:20', 0, 'H', 'nofoto.jpg'),
(10, 'prueba 2', 'contenido de prueba 2', '-8.111729024852341', '-79.02822839370117', '13', '1', '1350', '2014-07-25 18:52:39', 0, 'H', 'nofoto.jpg'),
(11, 'prueba 3', 'prueba 3', '-8.104308500000002', '-79.0364586', '13', '1', '1350', '2014-07-25 19:58:45', 0, 'H', 'http://files.parsetfss.com/a0123345-0b5c-4bbe-86e3-98d56cdc8497/tfss-ae4d6a61-487d-4930-9b34-3b9b7b7711c3-a3_66.jpg');
...
(40, 11, 'Pasaje Jorge Chavez 133', 12, 11, 'H'),
...
(9, 'Cambiar contraseña', 0, 'lock.png', 'H', 3);
...
(1, 'intranet/aplicacion', 'W', 1, '1', 'H'),
(2, 'intranet/opciones', 'W', 2, '1', 'H'),
(3, 'intranet/detalle_opciones', 'W', 3, '1', 'H'),
(4, 'intranet/parametros', 'W', 4, '1', 'H'),
(5, 'intranet/usuarios', 'W', 5, '1', 'H'),
(6, 'intranet/publicidad', 'W', 6, '1', 'H'),
(7, 'intranet/galeria_multimedia', 'W', 7, '1', 'H'),
(8, 'intranet/actualizar_datos', 'W', 8, '1', 'H'),
(9, 'intranet/cambiar_clave', 'W', 9, '1', 'H');
...
(1, 1, 'juan', '', '1', NULL, 'H'),
(2, 3, 'luiggichirinos_p@outlook.com', 'c945c4c755c89af72e507ef08c3ee71a', '1', '2014-07-11 19:50:06', 'H'),
...
(8, 8, 'luiggichirinos_p@outlook.com', 'e10adc3949ba59abbe56e057f20f883e', '2', '2014-07-18 19:09:07', 'H'),
