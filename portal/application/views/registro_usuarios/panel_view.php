        ...
        <div class="col-lg-5 col-md-5 col-sm-5">
            <div class="banner-wrapper">
                <div class="banner donate-banner3 animate-onscroll">
                    ...
                    $txt_ins_user_clave = form_input(array('name' => 'txt_ins_user_clave', 'id' => 'txt_ins_user_clave', 'placeholder' => 'Ingresar contrase&ntilde;a', 'maxlength' => '100'));
                    $txt_ins_user_repeclave = form_input(array('name' => 'txt_ins_user_repeclave', 'id' => 'txt_ins_user_repeclave', 'placeholder' => 'Repetir contrase&ntilde;a', 'maxlength' => '100'));
