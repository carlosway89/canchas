...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-07-2014 a las 18:32:11
...
(1, 'VillaSports Precursores', '', NULL, NULL, '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H'),
(2, 'Planeta Gol Club', 'Además de prestar un servicio a sus deportistas, Planeta Gol Club tiene como objetivo suplir las necesidades y comodidades de los acompañantes, porque como dice su propietario Jason Morales, el fútbol 5 es un deporte para disfrutar en familia.', NULL, NULL, '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H'),
(3, 'Canchas Soccer Math', 'Tiene dos sedes, una en el centro (Calle 19 # 4-71) y otra en Corferias (Avenida Las Américas # 39 - 36). Ambas cuentan con lo necesario para brindar un servicio grato a sus deportistas. ', NULL, NULL, '13', '2', '1361', '2014-07-03 00:00:00', 0, 'H'),
(4, 'Campín 5', 'Con el propósito de cumplirle a los deportistas y a sus acompañantes, este lugar cuenta con 5 canchas, cada una de ellas con un camerino propio, baño, duchas, puntos de hidratación, graderías para las barras de los equipos y parqueadero.', NULL, NULL, '15', '1', '1480', '2014-07-03 00:00:00', 0, 'H'),
(5, 'SPORT ARENA ', 'En el mítico barrio de Boedo se ubica uno de los mejores predios multideportivos para jugar al fútbol, el Campus Sport Arena. Este espacio tiene 8 canchas, seis de fútbol 5 y dos de fútbol 8. ', NULL, NULL, '13', '1', '1356', '2014-07-03 00:00:00', 0, 'H'),
(6, 'VIEYTES ', 'Arrimándonos a la zona sur de la ciudad pero sin alejarnos demasiado del centro, nos encontramos con el clásico Complejo Vieytes. Ahí se desarrollan desde hace muchos años torneos de alta calidad futbolística y muy bien organizados, tanto para particulares como para empresas', NULL, NULL, '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H'),
(7, 'MARANGONI ROSALES', 'Volviendo hacia la zona norte, detrás del club Obras Sanitarias, se destaca el predio de canchas Muni Fútbol en Núñez. Las canchas están en excelente estado y hay alternativas desde 6 hasta 8 jugadores, techadas y sin techar.', NULL, NULL, '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H'),
(8, 'MARANGONI ', 'En la zona norte de la ciudad y cerca del Alto Palermo, aparece un espacio en el que todo futbolista amateur alguna vez jugó un partidito: el Complejo Claudio Marangoni.', NULL, NULL, '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H');
